...
function blur(imageData, radius) {
  ...
  var blueSum = void 0;
  var alphaSum = void 0;
  var redOutSum = void 0;
  var greenOutSum = void 0;
  var blueOutSum = void 0;
  var alphaOutSum = void 0;
  var redInSum = void 0;
  var greenInSum = void 0;
  var blueInSum = void 0;
  var alphaInSum = void 0;
  var pr = void 0;
  var pg = void 0;
  var pb = void 0;
  var pa = void 0;
...
function constructLayer(img, layerProps, organ, layerName) {
  var rotation = _props.rotateClasses[layerProps.rotationIndex];
  var no45 = organ.el[layerProps.layerIndex].no45;
  ...
  if (layerProps.doInvert) {
    imageData = (0, _color.invert)(imageData);
  }
  ...
  if (organ.canScale && layerProps.doMove > 8) {
    ...
    if (layerProps.doMove > 11) {
      var maxXTranslate = state.canvas.width - xScale * state.canvas.width;
      var maxYTranslate = state.canvas.height - yScale * state.canvas.height;
  ...
  if (layerProps.showLayer && (window.layer === null || _props.layerGroups[window.layer].indexOf(layerName) !== -1)) {
...
function getN(maxValue) {
  ...
  var value = state.dna.substring(state.cursor, state.cursor + bitsCount);
...
function createLayer(layerName, elements, trans) {
  ...
  var layerProps = {
    ...
    rotationIndex: getN(_props.rotateClasses.length - 1, 'get rotation'),
...
function makePiece() {
  ...
  var newLayers = [['back-print', _props.organs, false], ['organ-00', _props.organs, true], ['foil', _props.foils, false], ['organ-01', _props.organs, true], ['organ-02', _props.organs, true], ['organ-03', _props.organs, true], ['things', _props.things, false], ['cuts', _props.cuts, false]];

  var allLayersCreated = (0, _lodash.reduce)(newLayers, function (p, newLayer) {
    return p.then(function () {
      return createLayer.apply(undefined, _toConsumableArray(newLayer));
    });
  }, Promise.resolve());
...
},{"./color":3,"./props":5,"jquery":1,"lodash":2}],5:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
var layerGroups = exports.layerGroups = {
...
//
var foils = exports.foils = [{
  fixedColor: true,
  folder: 'foils',
  el: [{ f: '000' }, { f: '001' }, { f: '002' }, { f: '003' }, { f: '004' }, { f: '005' }, { f: '006' }, { f: '007' }, { f: '008' }, { f: '009' }, { f: '011' }, { f: '001' }, { f: '012' }, { f: '003' }, { f: '004' }, { f: '005' }, { f: '006' }, { f: '007' }, { f: '008' }, { f: '009' }, { f: '000' }, { f: '001' }, { f: '012' }, { f: '003' }, { f: '004' }, { f: '005' }, { f: '006' }, { f: '007' }, { f: '008' }, { f: '009' }, { f: '010' }, { f: '011' }]
}];

var things = exports.things = [{
  folder: 'things',
  el: [{ f: '000' }, { f: '001' }, { f: '002' }, { f: '003' }, { f: '004' }, { f: '005' }, { f: '006' }, { f: '007' }, { f: '008' }, { f: '009' }, { f: '010' }, { f: '011' }, { f: '012' }, { f: '013' }, { f: '014' }, { f: '015' }, { f: '016' }, { f: '024' }, { f: '025' }, { f: '026' }, { f: '022' }, { f: '023' }, { f: '019' }, { f: '020' }, { f: '027' }, { f: '030' }, { f: '029' }, { f: '021' }, { f: '028' }, { f: '019' }, { f: '017' }, { f: '018' }]
}];

var cuts = exports.cuts = [{
  folder: 'cuts',
  canRotate: true,
  el: [{ f: '000' }, { f: '001' }, { f: '002' }, { f: '003' }, { f: '004' }, { f: '005' }, { f: '006' }, { f: '007' }, { f: '008' }, { f: '009' }, { f: '016' }, { f: '017' }, { f: '003' }, { f: '015' }, { f: '005' }, { f: '006' }, { f: '007' }, { f: '008' }, { f: '010' }, { f: '011' }, { f: '012' }, { f: '013' }, { f: '014' }, { f: '005' }, { f: '006' }, { f: '007' }, { f: '008' }, { f: '009' }, { f: '011' }, { f: '012' }, { f: '013' }, { f: '015' }]
}];

var rotateClasses = exports.rotateClasses = [0, -45, 90, 180, 0, 270, 180, 45];

var organs = exports.organs = [{
  folder: 'gradient-glow',
  canRotate: true,
  canBlur: true,
  canScale: true,
  el: [{ f: '000' }, { f: '001' }, { f: '002', no45: true }, { f: '003', no45: true }, { f: '004', no45: true }, { f: '005', no45: true }, { f: '006' }, { f: '007', no45: true }, { f: '008', no45: true }, { f: '009' }, { f: '010' }, { f: '011' }, { f: '012' }, { f: '013', no45: true }, { f: '014', no45: true }, { f: '015', no45: true }, { f: '016', no45: true }, { f: '001' }, { f: '002', no45: true }, { f: '003', no45: true }, { f: '004', no45: true }, { f: '005', no45: true }, { f: '006' }, { f: '007', no45: true }, { f: '008', no45: true }, { f: '009' }, { f: '010' }, { f: '011' }, { f: '012' }, { f: '013', no45: true }, { f: '014', no45: true }, { f: '015', no45: true }]
}, {
  folder: 'shapes',
  canRotate: true,
  canBlur: true,
  canScale: true,
  el: [{ f: '000' }, { f: '001', no45: true }, { f: '002', no45: true }, { f: '003' }, { f: '004' }, { f: '005' }, { f: '006' }, { f: '007' }, { f: '008' }, { f: '009' }, { f: '010' }, { f: '011' }, { f: '012' }, { f: '013', no45: true }, { f: '014' }, { f: '015', no45: true }, { f: '016', no45: true }, { f: '017', no45: true }, { f: '018', no45: true }, { f: '019' }, { f: '020' }, { f: '021', no45: true }, { f: '022' }, { f: '023' }, { f: '024' }, { f: '025' }, { f: '026' }, { f: '027' }, { f: '028' }, { f: '029' }, { f: '030', no45: true }, { f: '031' }]
}, {
  folder: 'surfaces',
  canRotate: true,
  canBlur: true,
  canScale: true,
  el: [{ f: '000', no45: true }, { f: '001', no45: true }, { f: '002' }, { f: '003', no45: true }, { f: '004' }, { f: '005' }, { f: '006', no45: true }, { f: '007' }, { f: '008' }, { f: '009' }, { f: '010' }, { f: '011', no45: true }, { f: '012' }, { f: '013', no45: true }, { f: '014', no45: true }, { f: '015' }, { f: '016' }, { f: '017' }, { f: '018' }, { f: '019', no45: true }, { f: '020', no45: true }, { f: '021', no45: true }, { f: '022', no45: true }, { f: '023', no45: true }, { f: '006', no45: true }, { f: '007' }, { f: '008' }, { f: '009' }, { f: '010' }, { f: '011', no45: true }, { f: '012' }, { f: '013', no45: true }]
}];
